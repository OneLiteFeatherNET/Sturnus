...
from sturnus.console.routes_report import GUILD_REPORTS, PARTICIPATION_REPORTS
...
def build_api(
    *,
    ...
    participation: ParticipationReports,
) -> web.Application:
    ...
    app[PARTICIPATION_REPORTS] = participation
    app.add_routes(
        [
